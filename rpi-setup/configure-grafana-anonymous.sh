...
sudo sed -i 's|^;root_url = .*|root_url = https://soil.owenmedeiros.com|' "$GRAFANA_INI"
sudo sed -i 's|^root_url = .*|root_url = https://soil.owenmedeiros.com|' "$GRAFANA_INI"
...
echo "User Signup:      ✗ Disabled"
echo "Public URL:       https://soil.owenmedeiros.com"
echo ""
...
echo "1. Log in as admin: https://soil.owenmedeiros.com"
